...
@pytest.fixture(name="s3")
def fix_s3(player_future_without_id):
    """ s3 """
    with mock_s3():
        s3 = boto3.client("s3", region_name="us-east-1")
        s3.create_bucket(Bucket="dataeng-futures-wh-qa")
...
def fix_environ():
    ...
    os.environ["PLAYER_MONGO_COLLECTION"] = "player_futures"
    os.environ["LEAGUE_PLAYER_MONGO_COLLECTION"] = "league_player_futures"
    os.environ["STAGE"] = "QA"
...
@pytest.fixture(name="player_future_without_id")
def get_player_future():
    """ get team future"""
    data = """
        [{
            "_id": "27f71aad-3369-3143-aa6c-245fc3b70a5b",
...
@pytest.fixture(name="player_future_with_id")
def get_player_future_with_id():
    """ get player future with id """
    data = """
        [{
            "team_id" : 405,
            "_id": "27f71aad-3369-3143-aa6c-245fc3b70a5b",
...
@pytest.fixture(name="player_future_with_no_market")
def get_player_future_with_no_market():
    """ get player future with no market """
    data = """[
        {
        "_id": "0c8ec734-4d98-32ee-8852-a9c4fde64f32",
        "id": "0c8ec734-4d98-32ee-8852-a9c4fde64f32",
